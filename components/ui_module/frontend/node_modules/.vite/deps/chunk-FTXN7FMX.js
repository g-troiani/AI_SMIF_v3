...
function link(curve) {
  let source = linkSource, target = linkTarget, x2 = x, y2 = y, context = null, output = null, path = withPath(link2);
  function link2() {
    let buffer;
...
//# sourceMappingURL=chunk-FTXN7FMX.js.map
